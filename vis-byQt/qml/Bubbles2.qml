...
Rectangle {
    ...
    property int numbubbles: 20;
    property real bubbleScaleFactor: 1
    property real maxBubbleRadius: width*0.015*bubbleScaleFactor + width/200*bubbleScaleFactor
    ...
    function createBubbles() {
        ...
        bubblesprites.push(bubblecomponent.createObject(bubbles2, {"x": width/2-radius , "y": height/2 - radius, "radius":radius, "color":  "#ec7e78" } ));
        var xLeft = -radius
        var xRight = radius
        for (var i=1; i < numbubbles; ++i) {
            ...
            if (i % 2 === 0) {
                bubblesprites.push(bubblecomponent.createObject(bubbles2, {"x": xLeft, "y": y, "radius":radius2 } ));
                xLeft += radius2*2
            } else {
                xRight -= radius2*2
                bubblesprites.push(bubblecomponent.createObject(bubbles2, {"x": xRight, "y": y, "radius":radius2 } ));
            }
        }
    }
